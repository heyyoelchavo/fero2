...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Name</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "➣fero"}" placeholder="Nickname" maxlength="18" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Room</label>
...
<div class="ui fluid selection profil bot-image dropdown" tabaindex="0">
  ...
  <div class="text"><img class="ui avatar image" src="https://media.discordapp.net/attachments/1114948314731905134/1131268216438661170/angry_iolite.jpg?width=427&height=427">Default</div>
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "➣fero"}" placeholder="Message text" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
      ...
      try {
        ...
        if (people) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "➣fero";
            username = "";
          }
        }
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "hahahah";
    messagetext = "hahahah";
  }
    ...
    socketList.forEach((socket) => {
      if (socket.readyState === WebSocket.OPEN) {
        ...
        if (regex.test(spamtext)) {
          document.querySelector('#spamtext input').value = "yare yare";
          spamtext = "yare yare";
        }
